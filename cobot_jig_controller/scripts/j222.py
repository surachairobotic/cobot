...
class RosbagRecord:
  def __init__(self):
    ...
    self.record_folder = "/home/dell/catkin_ws/src/cobot/record/wave_moving_5/"
...
#  exit()
  ...
  rospy.loginfo("vel = %f", state_move.velocity[0])
#  print("vel = %f" % state_move.velocity[0])
...
#      break
    if arm_state.position[0] < -2.0 or arm_state.position[0] > +2.0:
...
if __name__ == '__main__':
  ...
  mmin = math.radians(-30)
  mmax = math.radians(30)
  speed = 60
  ...
  jntEnd.position = [math.radians(90),0.0,math.radians(-90),0.0,math.radians(-90),0.0]
